...
| 搜历史分片日志 | `python <SKILL_PATH>/scripts/main.py prod my-service zgrep 2026-06-18 "Timeout"` |
...
```
- `file_keyword`：文件名匹配，通常传日期如 `2026-06-18`；传 `""` 匹配所有 `.zip`
- `content_keyword`：默认 `Exception|ERROR`
